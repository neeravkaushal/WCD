...
c
       open (1, file="myairshower.csv", status="unknown")
c                             Distances in km.
       h   = 4.5d0
       L   = 0.00000001
       c   = 2.99792458d5
...
c      write (*,*) z(i), abs(t_total(i) - t_min)*1.0d9
       write (1,*) t_total(i), b(i)
 100   continue
c                             Tell the world (part 2).
c      write (*,*) ' t_min = ', t_min*1.0d9
c      write (*,*) ' z(i) km , b(i) / b_ground '
c
       do 200 i=1, n
c      if (i.eq.1) write (*,*) z(i), b(i)*bground
c      if ((i/1000)*1000.eq.i) write (*,*) z(i), b(i)
 200   continue
c                             Stop the madness.
       stop
       end
