...
int main(int argc , char* argv[])
	{
	srand(time(0));
   const long   all_cases=atoi(argv[1]);
   const long   pi=3.141597;
   const double c=299792458.0/1.33, v=1.33*c, R=3.65, H=4.5;
   ...
   cout<<"Fraction         : "<<(double)counts/(double)cases<<endl;
   return 0;
}
